...
const tools = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Shows or hides the chat history sidebar that contains the chat history. Use this tool when user asks to show or hide or toggle the chat history.",
            parameters: {
                type: "object",
                properties: {},
                required: [],
    ...
    },
    {
        ...
        function: {
            name: "endChat",
            description: "Ends the chat and disconnects the user from the chat. whenever user wants to end chat or call use this tool.",
            parameters: {
                type: "object",
                properties: {},
                required: [],
